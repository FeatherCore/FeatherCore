#!/usr/bin/env bash
############################################################################
# tools/firmware/stm32h7s78-dk/build-nsh-esp_hosted_ng.sh
#
...
usage()
{
  ...
  printf 'Build STM32H7S78-DK NXboot and ESP-Hosted NG NSH app firmware.\n\n'
  ...
  printf '  FeatherCore_ESP/build/stm32h7s78-dk-nsh-esp_hosted_ng.bin\n'
...
app_image_bin="${build_dir}/stm32h7s78-dk-nsh-esp_hosted_ng.bin"
...
printf '\n==> Building STM32H7S78-DK ESP-Hosted NG NSH NXboot app\n'
distclean_tree
...
printf '  ESP-Hosted NG NSH NXboot app image:\n'
printf '    file:       %s\n' "${app_image_bin}"
