...
stale_loader_bin="${build_dir}/stm32h7s78-dk-nxboot-loader.bin"
stale_app_image_bin="${build_dir}/stm32h7s78-dk-nxboot-app.bin"
stale_app_raw_bin="${build_dir}/stm32h7s78-dk-nxboot-app-raw.bin"
...
mkdir -p "${build_dir}"
rm -f "${stale_loader_bin}" "${stale_app_image_bin}" "${stale_app_raw_bin}"
