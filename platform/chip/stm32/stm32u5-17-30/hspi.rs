...
//! Reference: RM0456 Section 27.4: HSPI register map
pub mod reg {
    /// HSPI control register
    //! Reference: RM0456 Section 27.4.1: HSPI control register (HSPI_CR)
    pub const CR: usize = 0x00;
    /// HSPI device configuration register 1
    //! Reference: RM0456 Section 27.4.2: HSPI device configuration register 1 (HSPI_DCR1)
    pub const DCR1: usize = 0x08;
    /// HSPI device configuration register 2
    //! Reference: RM0456 Section 27.4.3: HSPI device configuration register 2 (HSPI_DCR2)
    pub const DCR2: usize = 0x0C;
    /// HSPI device configuration register 3
    //! Reference: RM0456 Section 27.4.4: HSPI device configuration register 3 (HSPI_DCR3)
    pub const DCR3: usize = 0x10;
    /// HSPI device configuration register 4
    //! Reference: RM0456 Section 27.4.5: HSPI device configuration register 4 (HSPI_DCR4)
    pub const DCR4: usize = 0x14;
    /// HSPI status register
    //! Reference: RM0456 Section 27.4.6: HSPI status register (HSPI_SR)
    pub const SR: usize = 0x20;
    /// HSPI flag clear register
    //! Reference: RM0456 Section 27.4.7: HSPI flag clear register (HSPI_FCR)
    pub const FCR: usize = 0x24;
    /// HSPI data length register
    //! Reference: RM0456 Section 27.4.8: HSPI data length register (HSPI_DLR)
    pub const DLR: usize = 0x40;
    /// HSPI address register
    //! Reference: RM0456 Section 27.4.9: HSPI address register (HSPI_AR)
    pub const AR: usize = 0x48;
    /// HSPI data register
    //! Reference: RM0456 Section 27.4.10: HSPI data register (HSPI_DR)
    pub const DR: usize = 0x50;
    /// HSPI polling match mask register
    //! Reference: RM0456 Section 27.4.11: HSPI polling match mask register (HSPI_PSMKR)
    pub const PSMKR: usize = 0x80;
    /// HSPI polling match address register
    //! Reference: RM0456 Section 27.4.12: HSPI polling match address register (HSPI_PSMAR)
    pub const PSMAR: usize = 0x88;
    /// HSPI polling interval register
    //! Reference: RM0456 Section 27.4.13: HSPI polling interval register (HSPI_PIR)
    pub const PIR: usize = 0x90;
    /// HSPI communication configuration register
    //! Reference: RM0456 Section 27.4.14: HSPI communication configuration register (HSPI_CCR)
    pub const CCR: usize = 0x100;
    /// HSPI timing configuration register
    //! Reference: RM0456 Section 27.4.15: HSPI timing configuration register (HSPI_TCR)
    pub const TCR: usize = 0x108;
    /// HSPI instruction register
    //! Reference: RM0456 Section 27.4.16: HSPI instruction register (HSPI_IR)
    pub const IR: usize = 0x110;
    /// HSPI alternate bytes register
    //! Reference: RM0456 Section 27.4.17: HSPI alternate bytes register (HSPI_ABR)
    pub const ABR: usize = 0x118;
    /// HSPI low-power timeout register
    //! Reference: RM0456 Section 27.4.18: HSPI low-power timeout register (HSPI_LPTR)
    pub const LPTR: usize = 0x120;
    /// HSPI write communication configuration register
    //! Reference: RM0456 Section 27.4.19: HSPI write communication configuration register (HSPI_WCCR)
    pub const WCCR: usize = 0x140;
    /// HSPI write timing configuration register
    //! Reference: RM0456 Section 27.4.20: HSPI write timing configuration register (HSPI_WTCR)
    pub const WTCR: usize = 0x148;
    /// HSPI write instruction register
    //! Reference: RM0456 Section 27.4.21: HSPI write instruction register (HSPI_WIR)
    pub const WIR: usize = 0x150;
    /// HSPI write alternate bytes register
    //! Reference: RM0456 Section 27.4.22: HSPI write alternate bytes register (HSPI_WABR)
    pub const WABR: usize = 0x158;
    /// HSPI HyperBus latency configuration register
    //! Reference: RM0456 Section 27.4.23: HSPI HyperBus latency configuration register (HSPI_HLCR)
    pub const HLCR: usize = 0x200;
}

/// HSPI Control Register bits
/// Reference: RM0456 Section 27.4.1
pub mod cr_bits {
    /// HSPI enable
...
/// Reference: RM0456 Section 27.4.6
pub mod sr_bits {
...
/// Reference: RM0456 Section 27.4.2
pub mod dcr1_bits {
    /// Device type
...
/// Reference: RM0456 Section 27.4.3
pub mod dcr2_bits {
    /// Clock prescaler
...
/// Reference: RM0456 Section 27.4.14
pub mod ccr_bits {
    /// Instruction
...
/// Reference: RM0456 Section 27.4.23
pub mod hlcr_bits {
    /// Latency mode
