...
//! Reference: RM0456 Section 26.4: OCTOSPIM register map
pub mod reg {
    /// OCTOSPIM control register
    //! Reference: RM0456 Section 26.4.1: OCTOSPIM control register (OCTOSPIM_CR)
    pub const CR: usize = 0x00;
    /// OCTOSPIM IO manager control register
    //! Reference: RM0456 Section 26.4.2: OCTOSPIM IO manager control register (OCTOSPIM_PCR)
    pub const PCR: usize = 0x04;
    /// OCTOSPIM IO manager status register
    //! Reference: RM0456 Section 26.4.3: OCTOSPIM IO manager status register (OCTOSPIM_PCR)
    pub const SR: usize = 0x08;
    /// OCTOSPIM flag clear register
    //! Reference: RM0456 Section 26.4.4: OCTOSPIM flag clear register (OCTOSPIM_FCR)
    pub const FCR: usize = 0x0C;
}

/// OCTOSPIM Control Register bits
/// Reference: RM0456 Section 26.4.1
pub mod cr_bits {
    /// OCTOSPIM enable
...
/// Reference: RM0456 Section 26.4.2
pub mod pcr_bits {
    /// OCTOSPI1 enable
...
/// Reference: RM0456 Section 26.4.3
pub mod sr_bits {
    /// OCTOSPI1 busy
