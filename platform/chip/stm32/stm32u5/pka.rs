...
//!   - Register map: RM0456, Section 53.4, pages 2219-2241
//!   - PKA Control Register (PKA_CR): RM0456, Section 53.4.1, page 2220
//!   - PKA Status Register (PKA_SR): RM0456, Section 53.4.2, page 2222
//!   - PKA Clear Flag Register (PKA_CLRFR): RM0456, Section 53.4.3, page 2223
//!   - PKA RAM: RM0456, Section 53.4.4, page 2224
...
/// PKA register bit definitions
pub mod bits {
    /// PKA Control Register (PKA_CR) bits
    pub mod cr {
        /// Start Operation (START)
        pub const START: u32 = 1 << 0;
        /// Operation Mode (MODE)
        pub const MODE_MASK: u32 = 0xFF << 8;
    }

    /// PKA Status Register (PKA_SR) bits
    pub mod sr {
        /// Operation Done (PROC_DONE)
        pub const PROC_DONE: u32 = 1 << 0;
        /// RAM Error (RAMERR)
        pub const RAMERR: u32 = 1 << 1;
        /// Address Error (ADDRERR)
        pub const ADDRERR: u32 = 1 << 2;
        /// Operation Error (OPERR)
        pub const OPERR: u32 = 1 << 3;
    }

    /// PKA Clear Flag Register (PKA_CLRFR) bits
    pub mod clrfr {
        /// Clear PROC_DONE (CLRPROC_DONE)
        pub const CLRPROC_DONE: u32 = 1 << 0;
        /// Clear RAMERR (CLRRAMERR)
        pub const CLRRAMERR: u32 = 1 << 1;
        /// Clear ADDRERR (CLRADDRERR)
        pub const CLRADDRERR: u32 = 1 << 2;
        /// Clear OPERR (CLROPERR)
        pub const CLROPERR: u32 = 1 << 3;
    }
}
