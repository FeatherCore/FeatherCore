...
//!   - Register map: RM0456, Section 52.4, pages 2175-2194
//!   - OTFDEC Configuration Register 1 (OTFDEC_CR1): RM0456, Section 52.4.1, page 2176
//!   - OTFDEC Status Register (OTFDEC_SR): RM0456, Section 52.4.14, page 2189
//!   - OTFDEC Key Register (OTFDEC_KEYR): RM0456, Section 52.4.13, page 2188
//!   - OTFDEC Region Registers: RM0456, Section 52.4.5-52.4.12, pages 2180-2187
...
/// OTFDEC register bit definitions
pub mod bits {
    /// OTFDEC Configuration Register 1 (OTFDEC_CR1) bits
    pub mod cr1 {
        /// OTFDEC Enable (OTFDECEN)
        pub const OTFDECEN: u32 = 1 << 0;
        /// Region 1 Enable (R1EN)
        pub const R1EN: u32 = 1 << 8;
        /// Region 2 Enable (R2EN)
        pub const R2EN: u32 = 1 << 9;
        /// Region 3 Enable (R3EN)
        pub const R3EN: u32 = 1 << 10;
        /// Region 4 Enable (R4EN)
        pub const R4EN: u32 = 1 << 11;
    }

    /// OTFDEC Status Register (OTFDEC_SR) bits
    pub mod sr {
        /// Region 1 Access Error (R1AE)
        pub const R1AE: u32 = 1 << 0;
        /// Region 2 Access Error (R2AE)
        pub const R2AE: u32 = 1 << 1;
        /// Region 3 Access Error (R3AE)
        pub const R3AE: u32 = 1 << 2;
        /// Region 4 Access Error (R4AE)
        pub const R4AE: u32 = 1 << 3;
        /// Security Error (SECE)
        pub const SECE: u32 = 1 << 4;
    }
}
