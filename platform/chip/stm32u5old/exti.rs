...
pub mod reg {
    ...
    //! Reference: RM0456 Section 23.4.5: Falling edge pending register (EXTI_FPR1)
    pub const FPR1: usize = 0x10;
    /// Security rising edge pending register
    //! Reference: RM0456 Section 23.4.6: Security rising edge pending register (EXTI_SR1PR)
    pub const SR1PR: usize = 0x14;
    /// External interrupt configuration register 1
    //! Reference: RM0456 Section 23.4.7: External interrupt configuration register 1 (EXTI_EXTICR1)
    pub const EXTICR1: usize = 0x60;
    /// External interrupt configuration register 2
    //! Reference: RM0456 Section 23.4.7: External interrupt configuration register 2 (EXTI_EXTICR2)
    pub const EXTICR2: usize = 0x64;
    /// External interrupt configuration register 3
    //! Reference: RM0456 Section 23.4.7: External interrupt configuration register 3 (EXTI_EXTICR3)
    pub const EXTICR3: usize = 0x68;
    /// External interrupt configuration register 4
    //! Reference: RM0456 Section 23.4.7: External interrupt configuration register 4 (EXTI_EXTICR4)
    pub const EXTICR4: usize = 0x6C;
    /// Interrupt mask register 1
    //! Reference: RM0456 Section 23.4.8: Interrupt mask register (EXTI_IMR1)
    pub const IMR1: usize = 0x80;
    /// Event mask register 1
    //! Reference: RM0456 Section 23.4.9: Event mask register (EXTI_EMR1)
