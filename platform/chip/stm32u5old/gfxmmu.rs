...
//!
//! ## Reference / 参考
//! - RM0456 Reference Manual, Chapter 21: Graphics memory management unit (GFXMMU)
...
//! Reference: RM0456 Section 21.4: GFXMMU register map
pub mod reg {
    /// GFXMMU control register
    //! Reference: RM0456 Section 21.4.1: GFXMMU control register (GFXMMU_CR)
    pub const CR: usize = 0x00;
    /// GFXMMU status register
    //! Reference: RM0456 Section 21.4.2: GFXMMU status register (GFXMMU_SR)
    pub const SR: usize = 0x04;
    /// GFXMMU interrupt enable register
    //! Reference: RM0456 Section 21.4.3: GFXMMU interrupt enable register (GFXMMU_IER)
    pub const IER: usize = 0x08;
    /// GFXMMU clear flag register
    //! Reference: RM0456 Section 21.4.4: GFXMMU clear flag register (GFXMMU_CFR)
    pub const CFR: usize = 0x0C;
    /// GFXMMU LUT control register
    //! Reference: RM0456 Section 21.4.5: GFXMMU LUT control register (GFXMMU_LUTCR)
    pub const LUTCR: usize = 0x400;
    /// GFXMMU LUT address register
    //! Reference: RM0456 Section 21.4.6: GFXMMU LUT address register (GFXMMU_LUTAR)
    pub const LUTAR: usize = 0x404;
    /// GFXMMU LUT data register
    //! Reference: RM0456 Section 21.4.7: GFXMMU LUT data register (GFXMMU_LUTDR)
    pub const LUTDR: usize = 0x408;
    /// GFXMMU buffer control register
    //! Reference: RM0456 Section 21.4.8: GFXMMU buffer control register (GFXMMU_BCR)
    pub const BCR: usize = 0x800;
    /// GFXMMU buffer 0 address register
    //! Reference: RM0456 Section 21.4.9: GFXMMU buffer 0 address register (GFXMMU_B0AR)
    pub const B0AR: usize = 0x804;
    /// GFXMMU buffer 1 address register
    //! Reference: RM0456 Section 21.4.10: GFXMMU buffer 1 address register (GFXMMU_B1AR)
    pub const B1AR: usize = 0x808;
    /// GFXMMU buffer 2 address register
    //! Reference: RM0456 Section 21.4.11: GFXMMU buffer 2 address register (GFXMMU_B2AR)
    pub const B2AR: usize = 0x80C;
    /// GFXMMU buffer 3 address register
    //! Reference: RM0456 Section 21.4.12: GFXMMU buffer 3 address register (GFXMMU_B3AR)
    pub const B3AR: usize = 0x810;
    /// GFXMMU buffer OVR address register
    //! Reference: RM0456 Section 21.4.13: GFXMMU buffer OVR address register (GFXMMU_BOVR)
    pub const BOVR: usize = 0x814;
    /// GFXMMU buffer watermark register
    //! Reference: RM0456 Section 21.4.14: GFXMMU buffer watermark register (GFXMMU_BWTR)
    pub const BWTR: usize = 0x818;
    /// GFXMMU FCM control register
    //! Reference: RM0456 Section 21.4.15: GFXMMU FCM control register (GFXMMU_FCR)
    pub const FCR: usize = 0x1000;
    /// GFXMMU FCM source address register
    //! Reference: RM0456 Section 21.4.16: GFXMMU FCM source address register (GFXMMU_FSAR)
    pub const FSAR: usize = 0x1004;
    /// GFXMMU FCM destination address register
    //! Reference: RM0456 Section 21.4.17: GFXMMU FCM destination address register (GFXMMU_FDAR)
    pub const FDAR: usize = 0x1008;
    /// GFXMMU FCM size register
    //! Reference: RM0456 Section 21.4.18: GFXMMU FCM size register (GFXMMU_FSR)
    pub const FSR: usize = 0x100C;
}

/// GFXMMU Control Register bits
/// Reference: RM0456 Section 21.4.1
pub mod cr_bits {
    /// GFXMMU enable
...
/// Reference: RM0456 Section 21.4.2
pub mod sr_bits {
    /// Buffer busy
...
/// Reference: RM0456 Section 21.4.3
pub mod ier_bits {
...
/// Reference: RM0456 Section 21.4.5
pub mod lutcr_bits {
    /// LUT start
...
/// Reference: RM0456 Section 21.4.8
pub mod bcr_bits {
    /// Buffer 0 enable
...
/// Reference: RM0456 Section 21.4.15
pub mod fcr_bits {
    /// FCM enable
